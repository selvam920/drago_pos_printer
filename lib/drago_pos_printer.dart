...
export 'package:drago_pos_printer/services/bluetooth_printer_manager_web.dart'
    if (dart.library.html) 'package:drago_pos_printer/services/bluetooth_printer_manager_web.dart'
...
//     if (dart.library.js) 'package:drago_pos_printer/services/bluetooth_printer_manager.dart';
...
export 'package:drago_pos_printer/services/usb_printer_manager_web.dart'
    if (dart.library.html) 'package:drago_pos_printer/services/usb_printer_manager_web.dart'
